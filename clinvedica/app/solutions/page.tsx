  ...
  const services = [
    {
      ...
      features: ['FFPE', 'Frozen', 'Cryopreserved ', 'Healthy Tissues & Healthy Donors', 'Extracted DNA & RNA'],
    },
    {
      title: 'Blood & Derivatives',
      description: 'Serum, Plasma, Buffy Coat, Whole Blood, PBMC — handled with precision to ensure maximum sample integrity.',
      href: '/solutions/blood-derivatives',
      features: ['Serum & Plasma', 'Buffy Coat', 'PBMC', 'Whole Blood'],
    },
    {
      title: 'Biofluids',
      description: 'Urine, Saliva, CSF, Synovial Fluid, Ascites, Aqueous Humour, Bone Marrow, BMMNC, and more — verified and ready to support your specific study needs.',
      href: '/solutions/biofluids',
      features: ['Urine & Saliva', 'CSF', 'Bone Marrow', 'BMMNC', 'Others: sputum, semen, cord blood, tears'],
    },
    {
